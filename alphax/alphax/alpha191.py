...
class Alpha191(object):
    ...
    def alpha_5(self, data, param1=5, param2=5, param3=5, param4=-3, param5=-1,
    ...
    def alpha_12(self, data, param1=10, param2=-1, dependencies=['open_price','close_price','turnover_vol', 'vwap'],
                 max_window=10):
    ...
    def alpha_13(self, data, param1=0.5, dependencies=['highest_price','lowest_price', 'vwap'], max_window=1):
        # 要注意VWAP/price是否复权
        alpha = np.sqrt(data['highest_price'] * data['lowest_price']) - data['vwap']
        return alpha.iloc[-1]
    
    # CLOSE-DELAY(CLOSE,5)
    def alpha_14(self, data, param1=5, dependencies=['close_price'], max_window=6):
        # 与股价相关，利好茅台
        return data['close_price'].diff(param1).iloc[-1]

    # OPEN/DELAY(CLOSE,1)-1
    def alpha_15(self, data, param1=1, param2=-1, dependencies=['open_price', 'close_price'], max_window=2):
        # 跳空高开/低开
        return (data['open_price']/data['close_price'].shift(param1)+ param2).iloc[-1]
    
    # (-1*TSMAX(RANK(CORR(RANK(VOLUME),RANK(VWAP),5)),5))
    def alpha_16(self, data, param1=5, param2=5, param3=-1, dependencies=['turnover_vol', 'vwap'], max_window=10):
        # 感觉其中有个TSRANK
    ...
    def alpha_17(self, data, param1=15, param2=5, dependencies=['close_price', 'vwap'], max_window=16):
    ...
    # CLOSE/DELAY(CLOSE,5)
    def alpha_18(self, data, param1=5, dependencies=['close_price'], max_window=6):
        # 近5日涨幅, REVS5
    ...
    def alpha_19(self, data, param1=5, param2=5, param3=5, dependencies=['close_price'], max_window=6):
        # 类似于近五日涨幅
    ...
    # *100
    def alpha_23(self, data, param1=20, param2=1, param3=20, param4=20, 
    ...
    def alpha_24(self, data, param1=5, param2=5, param3=1, dependencies=['close_price'], max_window=10):
    ...
    def alpha_25(self, data, param1=7, param2=20, param3=9, param4=250,
    ...
    def alpha_26(self, data, param1=7, param2=5, param3=230, dependencies=['close_price', 'vwap'], max_window=235):
        vwap = data['vwap']
    ...
    def alpha_27(self, data, param1=3, param2=6, param3=12, dependencies=['close_price'], max_window=18):
    ...
    def alpha_28(self, data, param1=9, param2=9, param3=3, param4=3,
    ...
    def alpha_29(self, data, param1=6, dependencies=['close_price', 'turnover_vol'], max_window=7):
        # 获利成交量
        return (data['close_price'].pct_change(periods=param1)*data['turnover_vol']).iloc[-1]

    # (CLOSE-MEAN(CLOSE,12))/MEAN(CLOSE,12)*100
    def alpha_31(self, data, param1 = 12, dependencies=['close_price'], max_window=12):
        return ((data['close_price']/data['close_price'].rolling(window=param1,min_periods=param1).mean()-1.0)*100).iloc[-1]
    
    # (-1*SUM(RANK(CORR(RANK(HIGH),RANK(VOLUME),3)),3))
    def alpha_32(self, data, param1=3, param2=-3, param3=-1, dependencies=['highest_price', 'turnover_vol'], max_window=6):
    # 量价齐升/反转
    ...
    def alpha_33(self, data, param1=5, param2=5, param3=240, param4=20, param5=220, param6=-5,
    ...
    # MEAN(CLOSE,12)/CLOSE
    def alpha_34(self, data, param1=12, dependencies=['close_price'], max_window=12):
    ...
    def alpha_35(self, data, param1=7, param2=15, param3=0.65, param4=0.35, param5=17, param6=-1,
    ...
    def alpha_36(self, data, param1=6, param2=2, dependencies=['vwap', 'turnover_vol'], max_window=9):
        # 量价齐升, TSSUM
        vwap = data['vwap'].rank(axis=1, pct=True)
        vol = data['turnover_vol'].rank(axis=1, pct=True)
        corr_win = param1
    ...
    def alpha_37(self, data, param1=5, param2=5, param3=10, param4=-1, 
    ...
    def alpha_38(self, data, param1=20, param2=2, param3=-1, dependencies=['highest_price'], max_window=20):
        # 与股价相关，利好茅台
    ...
    def alpha_39(self, data, param1=2, param2=8, param3=0.3, param4=0.7, param5=180, param6=37, param7=14, param8=12, 
    ...
    def alpha_40(self, data, param1=26, param2=1, dependencies=['close_price', 'turnover_vol'], max_window=30):
        # 即VR技术指标
    ...
    def alpha_41(self, data, param1=3, param2=5, dependencies=['vwap'], max_window=9):
    ...
    def alpha_42(self, data, param1=10, param2=10 ,dependencies=['highest_price', 'turnover_vol'], 
                 max_window=10):
        # 价稳/量价齐升
    ...
    def alpha_43(self, data, param1=1, param2=1, param3=1, param4=6, 
    ...
    def alpha_44(self, data, param1=10, param2=7, param3=6, param4=4, param5=3, param6=10, param7=15,
    ...
    def alpha_45(self, data, param1=0.6, param2=0.4,param3=150,param4=15, dependencies=['open_price', 'close_price', 'vwap', 'turnover_vol'], max_window=165):
    ...
    def alpha_46(self, data, param1=3, param2=6, param3=12, param4=24, param5=4.0,
    ...
    def alpha_47(self, data, param1=6, param2=6, param3=6, param4=9,
    ...
    def alpha_48(self, data, param1=1, param2=1, param3=2, param4=5, param5=20, param6=-1,
                 dependencies=['close_price', 'turnover_vol'], max_window=20):
        # 下跌缩量
    ...
    def alpha_49(self, data, dependencies=['highest_price', 'lowest_price'], max_window=13):
   ...
   # (SUM(HIGH+LOW>=DELAY(HIGH,1)+DELAY(LOW,1)?0: MAX(ABS(HIGH-DELAY(HIGH,1)),ABS(LOW-DELAY(LOW,1))),12)
   # +SUM(HIGH+LOW<=DELAY(HIGH,1)+DELAY(LOW,1)?0:MAX(ABS(HIGH-DELAY(HIGH,1)),ABS(LOW-DELAY(LOW,1))),12))     
    def alpha_50(self, data, param1=1, param2=12, dependencies=['highest_price', 'lowest_price'], max_window=13):
    ...
    # (SUM(((HIGH+LOW)<=(DELAY(HIGH,1)+DELAY(LOW,1))?0:MAX(ABS(HIGH-DELAY(HIGH,1)),ABS(LOW-DELAY(LOW,1)))),12)
    # +SUM(((HIGH+LOW)>=(DELAY(HIGH,1)+DELAY(LOW,1))?0:MAX(ABS(HIGH-DELAY(HIGH,1)),ABS(LOW-DELAY(LOW,1)))),12))
    def alpha_51(self, data, param1=1, param2=12, dependencies=['highest_price', 'lowest_price'], max_window=13):
        condition1 = (data['highest_price'] + data['lowest_price']) <= (data['highest_price'] + data['lowest_price']).shift(1)
        condition2 = (data['highest_price'] + data['lowest_price']) >= (data['highest_price'] + data['lowest_price']).shift(1)
    ...
    def alpha_52(self, data, param1=3, param2=26, param3=1,
    ...
    def alpha_53(self, data, param1=1, param2=12, param3=12,
    ...
    # 注，这里STD没有指明周期
    def alpha_54(self, data, param1=10, param2=-1, dependencies=['close_price', 'open_price'], max_window=10):
        corr_win = param1
    ...
    def alpha_55(self, data, param1=1.5, param2=0.5, param3=2.0, param4=4.0, param5=16.0, param6=20,
    ...
    def alpha_56(self, data, param1=12, param2=0.5, param3=19, param4=40, param5=13, param6=5,
    ...
    def alpha_57(self, data, param1=9, param2=3, param3=1, 
    ...
    def alpha_58(self, data, param1=1, param2=20, dependencies=['close_price'], max_window=20):
        return ((data['close_price'].diff(param1) > 0.0).rolling(window=param2, min_periods=param2
    ...
    def alpha_59(self, data, param1=1, param2=20, dependencies=['close_price', 'lowest_price', 'highest_price'], 
                 max_window=21):
        # 受价格尺度影响
    ...
    def alpha_60(self, data, param1=20, param2=2, 
    ...
    def alpha_61(self, data, param1=1, param2=12, param3=80, param4=8, param5=17, 
    ...
    def alpha_62(self, data, param1=5, dependencies=['turnover_vol', 'highest_price'], max_window=5):
        corr_win = param1
    ...
    def alpha_63(self, data, param1=1, param2=6, param3=1, dependencies=['close_price'], max_window=7):
    ...
    def alpha_64(self, data, param1=4, param2=60, param3=13, param4=13, param5=14, param6=-1,
    ...
    # MEAN(CLOSE,6)/CLOSE
    def alpha_65(self, data, param1=6, dependencies=['close_price'], max_window=6):
        
        return (data['close_price'].rolling(window=param1, min_periods=param1).mean() / data['close_price']).iloc[-1]

    # (CLOSE-MEAN(CLOSE,6))/MEAN(CLOSE,6)*100
    def alpha_66(self, data, param1=6, dependencies=['close_price'], max_window=6):
    ...
    def alpha_67(self, data, param1=1, param2=24, dependencies=['close_price'], max_window=25):
    ...
    def alpha_68(self, data, param1=1, param2=0.5, param3=15, param4=2, 
    ...
    def alpha_69(self, data, param1=1, param2=20, 
    ...
    # STD(AMOUNT,6)
    def alpha_70(self, data, param1=6, dependencies=['turnover_value'], max_window=6):
        return data['turnover_value'].rolling(window=param1, min_periods=param1).std().iloc[-1]
    
    
    
    def alpha_71(self, data, param1=24, dependencies=['close_price'], max_window=25):
    ...
    def alpha_72(self, data, param1=6, param2=15, param3=1, 
    ...
    def alpha_73(self, data, param1=16, param2=10, param3=4, param4=5, param5=30, param6=4, param7=3, param8=-1,
    ...
    def alpha_74(self, data, param1=0.35, param2=0.65, param3=20, param4=40, param5=7, param6=6,
    ...
    def alpha_75(self, data, param1=50, dependencies=['close_price', 'open_price'], max_window=51):
    ...
    def alpha_76(self, data, param1=1, param2=20, dependencies=['close_price', 'turnover_vol'], max_window=21):
    ...
    def alpha_77(self, data, param1=0.5, param2=20, param3=40, param4=3, param5=6,
    ...
    def alpha_78(self, data, param1=12, param2=3, param3= 0.015, 
    ...
    # 就是RSI12
    def alpha_79(self, data, param1=12, param2=1, dependencies=['close_price'], max_window=13):
    ...
    def alpha_80(self, data, param1=5, dependencies=['turnover_vol'], max_window=6):
        # (VOLUME-DELAY(VOLUME,5))/DELAY(VOLUME,5)*100
        return (data['turnover_vol'].pct_change(periods=param1) * 100.0).iloc[-1]
    
    
    
    def alpha_81(self, data, param1=21, param2=2, dependencies=['turnover_vol'], max_window=21):
        # SMA(VOLUME,21,2)
        return data['turnover_vol'].ewm(adjust=False, alpha=float(param2)/param1, 
                                        min_periods=0, ignore_na=False).mean().iloc[-1]


    def alpha_82(self, data, param1=6, param2=20, param3=1, 
    ...
    def alpha_83(self, data, param1=5, dependencies=['highest_price', 'turnover_vol'], max_window=5):
    ...
    def alpha_84(self, data, param1=1, param2=20, dependencies=['close_price', 'turnover_vol'], max_window=21):
    ...
    def alpha_85(self, data, param1=20, param2=7, param3=8, dependencies=['close_price', 'turnover_vol'], max_window=40):
    ...
    def alpha_86(self, data, param1=20, param2=0.1, param3=10, param4=0.2, param5=0.25,
    ...
    def alpha_87(self, data, param1=4, param2=7, param3=0.5, param4=11,param5=-1,
    ...
    def alpha_88(self, data, param1=20, dependencies=['close_price'], max_window=21):
    ...
    def alpha_89(self, data, param1=13, param2=27, param3=10, param4=2, param5=2,
    ...
    def alpha_90(self, data, param1=5, param2=-1, dependencies=['vwap', 'turnover_vol'], max_window=5):
    ...
    def alpha_91(self, data, param1=5, param2=40, param3=-1, 
    ...
    def alpha_92(self, data, param1=3, param2=5, param3=180, param4=0.35, param5=0.65, param6=2, param7=3,
    ...
    def alpha_93(self, data, param1=1, param2=20, param3=0, 
    ...
    def alpha_94(self, data, param1=1, param2=30, dependencies=['close_price', 'turnover_vol'], max_window=31):
        # SUM((CLOSE>DELAY(CLOSE,1)?VOLUME:(CLOSE<DELAY(CLOSE,1)?-VOLUME:0)),30)
        part1 = np.sign(data['close_price'].diff(param1)) * data['turnover_vol']
        return part1.rolling(window=param2, min_periods=param2).sum().iloc[-1]


    def alpha_95(self, data, param1=20, dependencies=['turnover_value'], max_window=20):
        # STD(AMOUNT,20), 这里应该没有复权
        return data['turnover_value'].rolling(window=param1, min_periods=20).std().iloc[-1]
    
    def alpha_96(self, data, param1=9, param2=1, param3=3, 
                 dependencies=['close_price', 'lowest_price', 'highest_price'], max_window=100):
    ...
    def alpha_97(self, data, param1=10, param2=5, dependencies=['turnover_vol'], max_window=10):
        # STD(VOLUME,10)
        # 就是VSTD10
    ...
    def alpha_98(self, data, param1=100, param2=0.05, param3=3, param4=-1,
    ...
    def alpha_99(self, data, param1=5, dependencies=['close_price', 'turnover_vol'], max_window=5):
    ...
    def alpha_100(self, data, param1=20, param2=10, dependencies=['turnover_vol'], max_window=20):
        # STD(VOLUME,20), 就是VSTD20
        alpha = data['turnover_vol'].rolling(window=param1, min_periods=param2).std()
        return alpha.iloc[-1]


    def alpha_101(self, data, param1=30, param2=37, param3=15, param4=0.1, param5=0.9, param6=11, param7=-1,
    ...
    def alpha_102(self, data, param1=1, param2=0, param3=6, param4=1, 
    ...
    def alpha_103(self, data, param1=20, param2=20, dependencies=['lowest_price'], max_window=20):
    ...
    def alpha_104(self, data, param1=5, param2=5, param3=20, param4=-1,
    ...
    def alpha_105(self, data, param1=10, param2=-1, dependencies=['open_price', 'turnover_vol'], max_window=10):
    ...
    def alpha_106(self, data, param1=20, dependencies=['close_price'], max_window=21):
        # CLOSE-DELAY(CLOSE,20)
        return data['close_price'].diff(param1).iloc[-1]


    def alpha_107(self, data, param1=1, param2=-1, 
    ...
    def alpha_108(self, data, param1=2, param2=120, param3=6, param4=-1,
    ...
    def alpha_109(sel, data, param1=2, param2=10, dependencies=['highest_price', 'lowest_price'], max_window=20):
    ...
    def alpha_110(self, data, param1=1, param2=20, 
    ...
    def alpha_111(self, data, para1=11, param2=2, param3=4, param4=2,
    ...
    def alpha_112(self, data, param1=12, param2=1, dependencies=['close_price'], max_window=13):
    ...
    def alpha_113(self, data, param1=5, param2=20, param3=2, param4=5, param5=-1,
    ...
    def alpha_114(self, data, param1=5, param2=2,
    ...
    def alpha_115(self, data, param1=0.9, param2=0.1, param3=30, param4=10, param5=0.5,
    ...
    def alpha_118(self, data, param1=20, param2=20,
    ...
    def alpha_119(self, data, param1=5, param2=26, param3=5, param4=7,
    ...
    def alpha_120(self, data, dependencies=['vwap', 'close_price'], max_window=1):
        # RANK(VWAP-CLOSE)/RANK(VWAP+CLOSE)
        vwap = data['vwap']
        return ((vwap-data['close_price']).rank(axis=1,pct=True) / (vwap+data['close_price']).rank(axis=1,pct=True)).iloc[-1]


    def alpha_121(self, data, param1=12, param2=60, param3=2, param4=20, param5=18, param6=3, param7=-1,
    ...
    def alpha_122(self, data, param1=13, param2=2, 
                  dependencies=['close_price'], max_window=40):
    ...
    def alpha_123(self, data, param1=0.5, param2=20, param3=60, param4=9, param5=6,
    ...
    def alpha_124(self, data, param1=30, param2=2, 
    ...
    def alpha_125(self, data, param1=80, param2=17, param3=20, param4=0.5,
    ...
    def alpha_126(self, data, param1=3, dependencies=['highest_price', 'lowest_price', 'close_price'], max_window=1):
        # (CLOSE+HIGH+LOW)/3
        return (data['close_price'] + data['highest_price'] + data['lowest_price']).iloc[-1] / float(param1)


    def alpha_127(self, data, param1=12, param2=2, param3=0.5, dependencies=['close_price'], max_window=24):
    ...
    def alpha_128(self, data, param1=3, param2=1, param3=14, dependencies=['highest_price', 'lowest_price', 'close_price', 'turnover_vol'], max_window=14):
    ...
    def alpha_129(self, data, param1=1, param2=0, param3=12, 
                  dependencies=['close_price'], max_window=13):
    ...
    def alpha_130(self, data, param1=10, param2=3, param3=40, param4=0.5,param5=9,
    ...
    def alpha_131(self, data, param1=1, param2=50, param3=18, param4=18,
    ...
    def alpha_132(self, data, param1=20, dependencies=['turnover_value'], max_window=20):
        # MEAN(AMOUNT,20)
        return data['turnover_value'].rolling(window=param1, min_periods=param1).mean().iloc[-1]


    def alpha_133(self, data, param1=20, param2=20, param3=20, param4=20, 
    ...
    def alpha_134(self, data, param1=12, dependencies=['close_price', 'turnover_vol'], max_window=13):
        # (CLOSE-DELAY(CLOSE,12))/DELAY(CLOSE,12)*VOLUME
        return (data['close_price'].pct_change(periods=param1) * data['turnover_vol']).iloc[-1]


    def alpha_135(self, data, param1=20, param2=1, param3=20, param4=1, 
    ...
    def alpha_136(self, data, param1=3, param2=10,  param3=-1, 
    ...
    def alpha_137(self, data, param1=1.5, param2=0.5, param3=1, param4=2.0, param5=4.0, param6=16.0,
    ...
    def alpha_138(self, data, param1=20, param2=16, param3=0.3, param4=0.7, param5=3, param6=20,
    ...
    def alpha_139(self, data, param1=10, param2=-1, dependencies=['open_price', 'turnover_vol'], max_window=10):
        # (-1*CORR(OPEN,VOLUME,10))
        corr_df = rolling_corr(data['open_price'], data['turnover_vol'], param1)
        return corr_df.iloc[-1] * (param2)


    def alpha_140(self, data, param1=8, param2=60, param3=20, param4=8, param5=7, param6=3,
    ...
    def alpha_141(self, data, param1=15, param2=9, param3=-1,
    ...
    def alpha_142(self, data, param1=10, param2=20, param3=5, param4=1, param5=-1,
    ...
    def alpha_143(self, data, param1=1, param2=1, parm3=20, param4=1, 
                  dependencies=['close_price'], max_window=21):
        # CLOSE>DELAY(CLOSE,1)?(CLOSE-DELAY(CLOSE,1))/DELAY(CLOSE,1)*SELF:SELF
        # 表示 t-1 日的 alpha_143 因子计算结果
    ...
    def alpha_144(self, data, param1=1, param2=1, param3=20, param4=20, 
    ...
    def alpha_145(self, data, param1=9, param2=26, param3=12, dependencies=['turnover_vol'], max_window=26):
    ...
    def alpha_146(self, data, param1=61, param2=2, param3=20,
    ...
    def alpha_151(self, data, param1=20, param2=1, dependencies=['close_price'], max_window=41):
    ...
    def alpha_152(self, data, param1=9, param2=12, param3=26, param4=1, param5=1,
    ...
    def alpha_153(self, data, param1=3, param2=6, param3=12, param4=24, param5=4,
    ...
    def alpha_154(self, data, param1=16, param2=180, param3=18,
    ...
    def alpha_155(self, data, param1=13, param2=27, param3=10, param4=2, 
    ...
    def alpha_156(self, data, param1=5, param2=3, param3=0.15, param4=0.85,
    ...
    def alpha_157(self, data, param1=1, param2=5, param3=-1, param4=2, pram5=5, param6=-1,
    ...
    def alpha_158(self, data, dependencies=['lowest_price', 'highest_price', 'close_price'], max_window=1):
        # (HIGH-LOW)/CLOSE
        return ((data['highest_price'] - data['lowest_price']) / data['close_price']).iloc[-1]


    def alpha_159(self, data, param1=1, param2=6, param3=12, param4=24, 
    ...
    def alpha_160(self, data, param1=1, param2=20, param3=0, dependencies=['close_price'], max_window=41):
        # SMA((CLOSE<=DELAY(CLOSE,1)?STD(CLOSE,20):0),20,1)
    ...
    def alpha_161(self, data, param1=1, param2=12, 
    ...
    def alpha_162(self, data, param1=1, param2=1, param3=12, dependencies=['close_price'], 
                  max_window=25):
        # (SMA(MAX(CLOSE-DELAY(CLOSE,1),0),12,1)/SMA(ABS(CLOSE-DELAY(CLOSE,1)),12,1)*100
    ...
    def alpha_163(self, data, dependencies=['vwap', 'turnover_vol', 'close_price', 'highest_price'], max_window=20):
    ...
    def alpha_164(self, data, param1=1, param2=1, param3=12, param4=2, 
    ...
    def alpha_165(self, data, param1=48, dependencies=['close_price'], max_window=144):
    ...
    def alpha_166(self, data, param1=1, param2=20, param3=1.5, param4=2,
    ...
    def alpha_167(self, data, pararm1=1, param2=0, param3=12,
                  dependencies=['close_price'], max_window=13):
    ...
    def alpha_168(self, data, param1=20, dependencies=['turnover_vol'], max_window=20):
        # -1*VOLUME/MEAN(VOLUME,20)
        return (data['turnover_vol'] / (data['turnover_vol'].rolling(window=param1, 
                                        min_periods=param1).mean())).iloc[-1] * (-1)


    def alpha_169(self, data, param1=1, param2=1, param3=9, param4=12, param5=26, param6=10,
    ...
    def alpha_170(self, data, param1=1, param2=20, param3=5, param4=5,
    ...
    def alpha_171(self, data, param1=5, param2=-1,
    ...
    def alpha_172(self, data, param1=14, param2=6,
    ...
    def alpha_173(self, data, param1=13, param2=2, param3=2, param4=3, 
    ...
    def alpha_174(self, data, param1=20, param2=1, param3=0,
                      dependencies=['close_price'], max_window=41):
        # SMA((CLOSE>DELAY(CLOSE,1)?STD(CLOSE,20):0),20,1)
    ...
    def alpha_175(self, data, param1=1, param2=6, 
    ...
    def alpha_176(self, data, param1=12, param2=6, 
    ...
    def alpha_177(self, data, param1=20, param2=5, dependencies=['highest_price'], max_window=20):
    ...
    def alpha_178(self, data, param1=1, dependencies=['close_price', 'turnover_vol'], max_window=2):
        # (CLOSE-DELAY(CLOSE,1))/DELAY(CLOSE,1)*VOLUME
        return (data['close_price'].pct_change(periods=param1) * data['turnover_vol']).iloc[-1]


    def alpha_179(self, data, param1=4, param2=50, param3=12,
    ...
    def alpha_180(self, data, param1=7, param2=20, param3=60, param4=-1,
    ...
    def alpha_181(self, data, param1=20, param2=2, param3=3, 
                  dependencies=['close_price'], max_window=40):
    ...
    def alpha_182(self, data, param1=20, dependencies=['close_price', 'open_price'], max_window=20):
    ...
    def alpha_183(self, data, param1=24, dependencies=['close_price'], max_window=72):
    ...
    def alpha_184(self, data, param1=1, param2=200,
    ...
    def alpha_185(self, data, param1=-1, param2=1, param3=2,
    ...
    def alpha_186(self, data, param1=14, param2=6, param3=2,
                  dependencies=['highest_price', 'lowest_price', 'close_price'], max_window=30):
    # 即 DMI-ADXR
    # MTR:=SUM(MAX(MAX(HIGH-LOW,ABS(HIGH-REF(CLOSE,1))),ABS(REF(CLOSE,1)-LOW)),N);
    # HD :=HIGH-REF(HIGH,1);
    ...
    def alpha_187(self, data, param1=1, param2=0, param3=20,
    ...
    def alpha_188(self, data, param1=11, param2=2, 
    ...
    def alpha_189(self, data, param1=6, param2=6, dependencies=['close_price'], max_window=12):
    ...
    def alpha_190(self, data, param1=19, param2=20, param3=0.05, param4=1, param5=2,
                  dependencies=['close_price'], max_window=40):
    ...
    def alpha_191(self, data, param1=20, param2=5, param3=0.5,
